      ...
      final headerList = data.headerList!;
              return GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                 ...
                 final color = Color(int.parse(header.color!.replaceAll('#', ''), radix: 16) + 0xFF000000);
                 print("color:$color");

            final textColor = Color(int.parse(header.textColor!.replaceAll('#', ''), radix: 16) + 0xFF000000);
